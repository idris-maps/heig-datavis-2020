...
* [Les projets de fin de cours](projets.md)
...
* Le "scraping"
  - [En écoutant les requêtes](2020-04-03.md#le-scraping)
  - [Tirer des données d'une page HTML](2020-04-24.md#scraping-avec-cheerio)
* [Trouver des données cartographiques](modules/cartographie/trouver_des_donnees.md)

### Formats de données cartographiques
...
* [Transformer des données cartographiques avec `turf`](2020-04-24.md#turf)

## Visualisation

### SVG

* [Eléments et attributs de base](2020-02-21.md#svg)
* [Avec CSS et JS](2020-02-21.md#svg-dans-une-page-web)

### D3

* [Introduction à D3](https://observablehq.com/@idris-maps/introduction-a-d3)
* [Tutoriels et autres ressources](2020-03-06.md#d3)
* [Lier des données à des éléments](https://observablehq.com/@idris-maps/d3-joindre-des-donnees-a-des-elements)
* [Définir les axes](https://observablehq.com/@idris-maps/d3-definir-les-axes?collection=@idris-maps/heig-visdom-2020)
* [Camemberts, courbes... avec d3-shape](https://observablehq.com/@idris-maps/d3-shape)
* [Transitions](https://observablehq.com/@idris-maps/transitions-avec-d3)
